function [leb_tmp] = getLebedevHemiSphere(degree)
...
%leb_tmp.azi = zeros(degree,1);
%leb_tmp.zeni = zeros(degree,1);
%leb_tmp.r = zeros(degree,1);
...
leb_tmp.n = degree;
tokeep=leb_tmp.z>0 | (leb_tmp.z==0 & leb_tmp.x>0) | (leb_tmp.z==0 & leb_tmp.x==0 & leb_tmp.y>0);
leb_tmp.x=leb_tmp.x(tokeep);
leb_tmp.y=leb_tmp.y(tokeep);
leb_tmp.z=leb_tmp.z(tokeep);
leb_tmp.w=leb_tmp.w(tokeep);

leb_tmp.weight=leb_tmp.w/2/pi;
[leb_tmp.azi,leb_tmp.elev,leb_tmp.r]=cart2sph(leb_tmp.x,leb_tmp.y,leb_tmp.z);
leb_tmp.zeni=pi/2-leb_tmp.elev;
end
