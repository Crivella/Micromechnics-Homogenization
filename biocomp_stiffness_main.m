...
%A)numerical
tol=6; %6 for quick computation, better 8 or even 10
...
comp.fib.mchem.wax=NaN; %optional, wax content [-], w.r.t. cell wall mass
...
comp.mat.E=NaN;%optional, matrix modulus [GPa]
comp.mat.nu=NaN;%optional, matrix Poisson's ratio [-], note that stiffness of matrix has to be defined, so if not in the database, it has to be defined here
...
comp.mat.fair=NaN;%optional, air porosity [-], default is zero
